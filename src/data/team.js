...
export const team = [
  { id: 'novak', name: 'Jan Novák', role: 'Jednatel', note: 'Vede firmu i výběr lokalit. Za IKO ručí svým jménem.', email: 'projekty@ikoplzen.cz' },
  ...
  { id: 'benes', name: 'Tomáš Beneš', role: 'Financování', note: 'Poradí s hypotékou i splátkovým kalendářem.', email: 'projekty@ikoplzen.cz' },
